 ...
 *
 * description: this task control will calculate value of joystick signal
...
const RTE_eventTable_t RTE_eventActivationTable_tsk_control[] = {
    { CONTROL_calcControl_run, ev_on_JoystickUpdate },  //Runnable that checks the joystick signal and depending upon that value speed signal is updated
}; 
...
TASK(tsk_control)
{
    ...
    while(1)
    {
        ...
        WaitEvent(ev_on_JoystickUpdate);
